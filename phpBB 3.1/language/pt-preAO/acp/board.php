...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'		=> 'Este interruptor permite ativar/desactivar globalmente a Resposta Rápida em todo o Fórum. Quando activado, terá ainda que ativar a Resposta Rápida individualmente em cada um dos Fóruns.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_WARNING'			=> 'Por favor, note que o método de activação seleccionado actualmente exige que o envio de emails esteja activado, de outra forma de registo será desactivado. Recomendamos que seleccione um método de activação diferente ou ative o envio de emails.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_TOPICS_ACTIVE_EXPLAIN'	=> 'Activa Feeds nos "Tópicos ativos”, exibindo os últimos Tópicos activos, incluindo as últimas mensagens.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'			=> 'Aqui pode ativar e desactivar a página de contacto e adicionar o texto que será exibido.',
...
// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'				=> 'Aqui pode ativar e desactivar certas funções do Fórum que podem reduzir o total de processamento pedido. Para a maioria dos Servidores não é necessário desactivar nenhuma função. No entanto, em certos sistemas ou em ambientes de hospedagem compartilhada pode ser benéfico se desactivar alguns recursos que não sejam realmente necessário. Pode também especificar limites para a carga do sistema e ativar sessões, além das quais o Fórum sairá do ar.',
	...
	'YES_BIRTHDAYS_EXPLAIN'					=> 'Se desactivar esta opção a lista de aniversariantes não será mostrada. Para que esta opção funcione a opção de ativar Aniversários também precisa estar ativada.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE_EXPLAIN' 			=> 'Quando activado, as URLs que contenham ’app.php’ serão reescritas para remover o nome do ficheiro (ou seja, app.php/foo transforma-se em /foo). <strong>O mod_rewrite tem que estar activado no Servidor Apache. Ativando esta opção sem o mod_rewrite, poderá comprometer o funcionamento do seu Fórum.</strong>',
	'MOD_REWRITE_DISABLED'					=> 'O módulo <strong>mod_rewrite</strong> está desactivado no seu servidor web Apache. Active o módulo ou entre em contacto com seu serviço de hospedagem web, para ativar este recurso.',
...
$lang = array_merge($lang, array(
	...
	'AUTOLOGIN_LENGTH_EXPLAIN'				=> 'Duração da chave "Esqueci-me da senha" em dias. 0 para desactivar.',
