...
$help = array(
	...
	array(
		...
		1 => 'No Painel de Controlo do Utilizador [UCP], aba Preferências, opção Configurações Pessoais, selecione Sim em Ocultar o meu estado Online. Desta forma só o Administrador e os Moderadores poderão vê-lo Online. Passará a ser considerado Utilizador invisível pelo Sistema.'
	),
	array(
		0 => 'A Data e Hora estão erradas!',
		1 => 'Se tem certeza de ter definido o fuso horário corretamente e a hora continua errada, então o horário definido no relógio do servidor está incorreto. Por favor, contacte o administrador para corrigir o problema.'
	),
	array(
	...
	array(
		...
		1 => 'Alguns fórum podem ser restringidos a alguns utilizadores ou grupos. Para ver, ler, enviar mensagem ou efetuar qualquer outra ação, poderá precisar de permissões especiais. Contacte um moderador ou administrador para lhe garantir o acesso.'
	),
	array(
