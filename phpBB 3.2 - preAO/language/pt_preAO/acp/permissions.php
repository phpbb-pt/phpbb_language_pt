...
$lang = array_merge($lang, array(
	...
	'ACL_NO'				=> 'Não',
	'ACL_VIEW'				=> 'Inspecção das Permissões',
	...
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> 'Permissões de Moderador de Fórum dos Utilizadores e/ou Grupos e Fóruns seleccionadas.',
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> 'Permissões de Utilizador dos Utilizadores e/ou Grupos seleccionados.',
	...
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> 'A Permissão de Utilizador independente do Fórum está avaliada como <strong>SIM</strong> que substitui o resultado local actual <strong>NUNCA</strong>. %sCópia da Permissão Global%s',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'A Permissão do Utilizador está assinalada como <strong>NUNCA</strong> e o valor total está assinalado como <strong>NUNCA</strong> e substitui o sim prévio.',
	...
	'TRACE_USER_YES_TOTAL_YES'				=> 'A Permissão do Utilizador está assinalada como <strong>SIM</strong> e o valor total é assinalado como <strong>SIM</strong>, então nada é alterado.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'A Permissão do Utilizador está assinalada como <strong>SIM</strong> e o valor total é assinalado como <strong>SIM</strong>, então nada é alterado.',
	'TRACE_WHO'								=> 'Quem',
	'TRACE_TOTAL'							=> 'Total',
