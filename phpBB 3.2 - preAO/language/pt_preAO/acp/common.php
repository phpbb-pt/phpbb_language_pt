...
$lang = array_merge($lang, array(
	...
	'CANNOT_MIRROR_DIRECTORY'		=> 'Incapaz de criar uma cópia de um directório',
	...
	'DIRECTORY_NOT_DIR'			=> 'A Pasta "%s" seleccionada não é uma pasta.',
...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_INDEX'				=> 'O modo de pesquisa seleccionado não possui um índice de pesquisa.<br />Por favor, crie o índice para “%1$s” na secção %2$spesquisa de índice%3$s.',
...
$lang = array_merge($lang, array(
	...
	'LOG_EXT_UPDATE'	=> '<strong>Extensão actualizada</strong><br />» %s',
));
