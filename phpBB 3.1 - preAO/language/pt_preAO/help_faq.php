...
$help = array(
	...
	array(
		0 => 'Por que motivo tenho de me registar?',
		1 => 'Compete ao administrador do fórum decidir se para poder criar mensagens, o registo é obrigatório. No entanto; o registo dá-lhe acesso a ferramentas adicionais não disponíveis aos visitantes, como definir imagens de avatar, mensagens privadas, e-mail de outros utilizadores, subscrição de Grupos, etc. Leva apenas alguns minutos para se registar, daí ser recomendável que o faça.'
	),
	array(
		0 => 'O que significa COPPA?',
		1 => 'COPPA, ou Lei de Protecção da Privacidade Online Infantil de 1998,  é uma Lei dos EUA que exige uma autorização dos encarregados de educação, ou de um responsável legal, para guardar as informações relativas a menores de 13 anos de idade. Caso não saiba se isso se aplica a si, obtenha aconselhamento legal. Por favor, esteja ciente de que nem o phpBB Limited nem o fundador deste fórum o pode aconselhar em termos legais, à excepção da questão “Quem devo contactar em caso de abusos e/ou assuntos legais relacionados com este fórum?”.',
	),
	array(
	...
	array(
		0 => 'Registei-me e já entrei anteriormente, mas agora não consigo!',
		1 => 'É possível que o administrador tenha excluído o seu registo por algum motivo. Além disso, há administradores que removem registos de utilizadores que nunca colocaram mensagens, de modo a reduzir o tamanho da Base de Dados. Se isso aconteceu, tente registar-se novamente e ser participativo no fórum.'
	),
	array(
	...
	array(
		...
		1 => '“Apaga do seu PC todos os Cookies criados pelo phpBB3 e que servem para o manter ligado e autenticado, e permitem o pleno funcionamento das opções activadas pelo Administrador.',
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'No Painel de Controlo do Utilizador [UCP], aba Preferências, opção Configurações Pessoais, seleccione Sim em Ocultar o meu estado Online. Desta forma só o Administrador e os Moderadores poderão vê-lo Online. Passará a ser considerado Utilizador invisível pelo Sistema.'
	),
	array(
		0 => 'A Data e Hora estão erradas!',
		1 => 'Se tem certeza de ter definido o fuso horário correctamente e a hora continua errada, então o horário definido no relógio do servidor está incorrecto. Por favor, contacte o administrador para corrigir o problema.'
	),
	array(
	...
	array(
		0 => 'Porque não consigo aceder a um fórum?',
		1 => 'Alguns fórum podem ser restringidos a alguns utilizadores ou grupos. Para ver, ler, enviar mensagem ou efectuar qualquer outra acção, poderá precisar de permissões especiais. Contacte um moderador ou administrador para lhe garantir o acesso.'
	),
	array(
	...
	array(
		...
		1	=> 'Se o Administrador tiver activado esta opção, vá até à mensagem que deseja denunciar e verá um botão que serve para denunciar Mensagens. Clicando ali, será encaminhado às etapas necessárias para denunciar a mensagem.',
	),
	array(
	...
	array(
		...
		1	=> 'Para se inscrever num Grupo de Utilizadores, clique no atalho de Grupos no topo da página (dependendo do Tema em uso), podendo então ver todos os Grupos. Nem todos os Grupos possuem um acesso aberto, alguns estão fechados e alguns poderão inclusive encontrar-se invisíveis. Se o Grupo se encontrar aberto, poderá solicitar sua inscrição clicando no botão apropriado. O Líder do Grupo de Utilizadores precisará aprovar a sua inscrição, podendo perguntar-lhe o motivo do mesmo. Por Favor, não insista a um Líder de Grupo caso a sua inscrição seja recusada. Ele deverá informá-lo a respeito de qualquer decisão.',
	),
	array(
	...
	array(
		...
		1	=> 'Pode adicionar Utilizadores na sua lista de duas formas. Através do Perfil de cada Utilizador, existe um atalho para adicioná-los à sua lista. De maneira alternativa, pode adicionar Utilizadores directamente escrevendo os seus Nomes de Utilizadores. Pode também apagar Utilizadores de sua lista utilizando a mesma página.',
	),
	array(
		0	=> '--',
		1	=> 'Sobre a Pesquisa',
	...
	array(
		...
		1	=> 'Escrevendo um Termo de Pesquisa na respectiva página localizada no Índice do Fórum, Visualizando Tópicos ou Secções. Pode aceder à Pesquisa Avançada clicando no atalho Pesquisar que encontra-se disponível em todas as páginas do Fórum.',
	),
	array(
	...
	array(
		...
		1	=> 'Entre na Página dos Utilizadores e clique no atalho Pesquisar um Utilizador. Ao seleccionar, siga restritamente às opções descritas na página.',
	),
	array(
		0	=> 'Como posso Pesquisar minhas Próprias Mensagens e Tópicos?',
		1	=> 'As suas próprias Mensagens podem ser exibidas clicando em Mensagens do Utilizador através do Painel de Utilizadores ou apenas pelo seu próprio Perfil. Para encontrar os seus Tópicos, utilize a Pesquisa Avançada e preencha correctamente as opções.',
	),
	array(
		0	=> '--',
		1	=> 'Sobre a Observar e Favoritos',
	),
	array(
		0	=> 'Qual é a diferença existente entre Favoritos e Observar?',
