...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'			=> 'Esquemas permitidos em links',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'	=> 'Os usuários só podem publicar URLs sem esquemas ou uma da lista separada por vírgulas de esquemas permitidos.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'			=> 'Estas configurações definem os dados usados nos cookies enviados aos navegadores do Utilizadores. Na generalidade dos casos os valores abaixo são suficientes. Se os mudar faça-o com cuidado. Qualquer incorreção impede os Utilizadores de aceder ao Fórum. Se você tiver problemas com os usuários que estão logando no seu fórum, visite o <b><a href="https://www.phpbb.com/support/go/cookie-settings/">phpBB.com Knowledge Base - Corrigindo configurações de cookies incorretas</a></b>.',

	'COOKIE_DOMAIN'							=> 'Domínio do Cookie',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'Na maioria dos casos, o domínio do cookie é opcional. Deixe-o em branco se você não tiver certeza.<br /><br /> No caso em que você tenha uma placa integrada com outro software ou tenha vários domínios, então, para determinar o domínio do cookie, você deve fazer o seguinte. Se você tem algo como <i>example.com</i> e <i>forums.example.com</i>, ou talvez <i>forums.example.com</i> e <i>blog.example.com</i>. Remova os subdomínios até encontrar o domínio comum, <i>example.com</i>. Agora, adicione um ponto na frente do domínio comum e digite .example.com (Note o ponto no início).',
	'COOKIE_NAME'							=> 'Nome do Cookie',
	'COOKIE_NAME_EXPLAIN'		=> 'Isso pode ser qualquer coisa que você deseja, torná-lo original. Sempre que as configurações de cookies forem alteradas, o nome do cookie deve ser alterado',
	'COOKIE_NOTICE'				            => 'Aviso do Cookie',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Se ativado, um aviso do cookie será mostrado aos utilizadores quando estes visitarem o seu fórum. Poderá ser exigido por lei, dependendo do conteúdo do fórum e das extensões ativadas.',
	'COOKIE_PATH'							=> 'Caminho do Cookie',
	'COOKIE_PATH_EXPLAIN'		=> 'Observe que esta é sempre uma barra, não importa o que é o URL do seu forum.',
...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_LIMIT'				=> 'Limite de publicação de atividades do usuário',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'		=> 'O tópico / fórum ativo não será exibido para os usuários que tenham mais do que esse número de postagens. Defina para 0 para desativar o limite.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'		=> 'Permitir conexões ao servidor SMTP com certificado SSL auto-assinado.<em><strong>Atenção:</strong> Permitir certificados SSL auto-assinados pode causar implicações de segurança.</em>',
	...
	'SMTP_VERIFY_PEER'						=> 'Verifique o certificado SSL',
+	'SMTP_VERIFY_PEER_EXPLAIN'				=> 'Exigir a verificação do certificado SSL usado pelo servidor SMTP.<em><strong>Atenção:</strong> Conectando pares com certificados SSL não verificados pode causar implicações de segurança.</em>',
+	'SMTP_VERIFY_PEER_NAME'					=> 'Verifique o nome da empresa SMTP',
+	'SMTP_VERIFY_PEER_NAME_EXPLAIN'			=> 'Exigir verificação do nome do mesmo para servidores SMTP usando conexões SSL / TLS.<em><strong>Atenção:</strong> Ligar a pares não verificados pode causar implicações de segurança.</em>',
...
+	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Permitir conexões ao servidor Jabber com certificado SSL auto-assinado.<em><strong>Atenção:</strong> Permitir certificados SSL auto-assinados pode causar implicações de segurança.</em>',
+	'JAB_ENABLE'					=> 'Ativar Jabber',
+	'JAB_ENABLE_EXPLAIN'			=> 'Permite o uso de mensagens e notificações Jabber.',
+	'JAB_GTALK_NOTE'				=> 'Por favor, note que o GTalk não funcionará porque o <samp>dns_get_record</samp>   A função não pôde ser encontrada. Esta função não está disponível no PHP4, e não é implementada em plataformas Windows. Atualmente não funciona em sistemas baseados em BSD, incluindo Mac OS.',
+	'JAB_PACKAGE_SIZE'				=> 'Tamanho do pacote Jabber',
+	'JAB_PACKAGE_SIZE_EXPLAIN'		=> 'Este é o número de mensagens enviadas em um pacote. Se configurado para 0, a mensagem é enviada imediatamente e não será enfileirada para posterior envio.',
+	'JAB_PASSWORD'					=> 'Senha Jabber',
+	'JAB_PASSWORD_EXPLAIN'			=> '<em><strong>Atenção:</strong>   Esta senha será armazenada como texto simples no banco de dados, visível para todos que podem acessar seu banco de dados ou quem pode visualizar esta página de configuração.</em>',
...
+	'JAB_SERVER_EXPLAIN'			=> 'Veja %sjabber.org%s para obter uma lista de servidores.',
+	'JAB_SETTINGS_CHANGED'			=> 'As configurações do Jabber mudaram com sucesso.',
+	'JAB_USE_SSL'					=> 'Use SSL para conectar',
+	'JAB_USE_SSL_EXPLAIN'			=> 'Se for habilitada, é provada a conexão segura. A porta Jabber será modificada para 5223 se a porta 5222 for especificada.',
+	'JAB_USERNAME'					=> 'Nome de usuário Jabber ou JID',
+	'JAB_USERNAME_EXPLAIN'			=> 'Especifique um nome de usuário registrado ou um JID válido. O nome de usuário não será validado. Se você apenas especificar um nome de usuário, seu JID será o nome de usuário e o servidor que você especificou acima. Caso contrário, especifique um JID válido, por exemplo, user@jabber.org.',
+	'JAB_VERIFY_PEER'				=> 'Verifique o certificado SSL',
+	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Exigir a verificação do certificado SSL usado pelo servidor Jabber.<em><strong>Atenção:</strong> Conectando pares com certificados SSL não verificados pode causar implicações de segurança.</em>',
+	'JAB_VERIFY_PEER_NAME'			=> 'Verifique o nome do Jabber peer',
+	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Exigir verificação do nome do parceiro para servidores Jabber usando conexões SSL / TLS.<em><strong>Atenção:</strong> Ligar a pares não verificados pode causar implicações de segurança.</em>',
));
