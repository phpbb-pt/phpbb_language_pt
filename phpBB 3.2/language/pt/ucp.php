...
$lang = array_merge($lang, array(
	...
	'EMAIL_NOT_UNIQUE'					=> 'O E-mail especificado é usado por vários usuários. Você também deve especificar o nome de usuário.',
	...
	'PASSWORD_UPDATED_IF_EXISTED'		=> 'Se a sua conta existir, uma nova senha foi enviada para o seu endereço de e-mail registrado. Se você não receber um e-mail, pode ser porque você foi banido, sua conta não está ativada ou você não tem permissão para alterar sua senha. Entre em contato com o administrador se algum desses motivos se aplicar. Além disso, verifique seu filtro de spam.',
