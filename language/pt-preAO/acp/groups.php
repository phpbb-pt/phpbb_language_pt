...
$lang = array_merge($lang, array(
	...
	'GROUP_COLOR_EXPLAIN'				=> 'Seleccione a cor dos Utilizadores do Grupo. Deixe em branco se não deseja ativar esta opção.',
	...
	'GROUP_LIST_EXPLAIN'				=> 'Esta é uma lista completa de todos os Membros atuais com Direcção Geral neste Grupo. Pode apagar Utilizadores (exceto em certos Grupos especiais) ou adicionar novos como pode ver.',
	'GROUP_MEMBERS'						=> 'Membros do Grupo',
	'GROUP_MEMBERS_EXPLAIN'				=> 'Esta é uma lista completa dos Membros deste Grupo. Inclui secções separadas para Líderes, pendentes e Membros atuais. Neste Painel pode configurar os gestores deste Grupo e as suas tarefas. Para apagar um Líder sem retirá-lo do Grupo, use a Opção Demitir Líder. Para promover um Membro do Grupo a Líder seleccione Promover Líder.',
