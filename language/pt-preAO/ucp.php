...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'				=> 'A sua conta foi atualizada. Neste Fórum as alterações de email requerem a reactivação. A chave de activação foi enviada para o seu novo endereço de email. Para mais detalhes verifique o seu endereço de email.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'		=> 'A sua conta foi atualizada. Neste Fórum as alterações de email requerem a reactivação por um administrador. Receberá um email quando a sua conta for reactivada.',
	...
	'DEFAULT_ACTION_EXPLAIN'			=> 'Esta acção será ativada se nenhuma das anteriores forem aplicáveis.',
	...
	'UCP_ADMIN_ACTIVATE'			=> 'Tem de introduzir um endereço de email válido para que o Registo seja activado. O Administrador verificará o seu Registo, e, se for Aprovado, receberá um email para ativar a sua conta.',
