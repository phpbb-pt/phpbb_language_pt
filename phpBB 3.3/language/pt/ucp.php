...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Ao aceder a “%1$s” (também denominado como  “nós”, “nos”, “nossos”, “%1$s”, “%2$s”), concorda em estar legalmente vinculado aos seguintes termos. Caso não concorde com todos os termos seguintes, por favor não aceda nem utilize “%1$s”. Poderemos alterar estes termos a qualquer momento e faremos todo o possível para o informar sobre tais alterações. No entanto, é da sua responsabilidade rever este documento regularmente, uma vez que a utilização contínua de “%1$s” após a implementação de alterações constitui a sua concordância em estar legalmente vinculado aos termos atualizados e/ou alterados.
	<br><br>
	Os nossos fóruns são desenvolvidos por phpBB (também denominado como  “eles”, “deles”, “seu”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipas phpBB”), uma solução de fórum online lançada sob a “<a href="https://opensource.org/license/gpl-2-0">Licença Pública Geral GNU v2</a>” (conhecida como “GPL”), que pode ser descarregada em <a href="https://www.phpbb.com/">www.phpbb.com</a>. O software phpBB apenas facilita as discussões online; a phpBB Limited não se responsabiliza pelo conteúdo ou conduta permitida ou proibida neste site. Para mais informações sobre o phpBB, consulte: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Concorda em não publicar qualquer material abusivo, obsceno, vulgar, difamatório, odioso, ameaçador, de teor sexual ou de qualquer outra forma ilegal, seja pelas leis do seu país, do país onde o “%1$s” está alojado ou pelo direito internacional. Fazê-lo poderá resultar na sua proibição imediata e permanente, com notificação ao seu ISP, se considerarmos necessário. O endereço IP de todas as publicações é registado para auxiliar na aplicação destas condições.
	<br><br>
	Concorda que o “%1$s” se reserva o direito de remover, editar, mover ou fechar qualquer tópico a qualquer momento, a nosso exclusivo critério. Como utilizador, concorda que qualquer informação que insira poderá ser armazenada numa base de dados. Embora esta informação não seja divulgada a terceiros sem o seu consentimento, nem o “%1$s” nem o phpBB serão responsabilizados por qualquer tentativa de intrusão que possa levar ao comprometimento de dados.
	',

	'PRIVACY_POLICY'		=> 'Esta política explica detalhadamente como a “%1$s” e as suas empresas afiliadas (denominado como “nós”, “nos”, “nossos”, “%1$s”, “%2$s”) e o phpBB (denominado como “eles”, “deles”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipas phpBB”) utilizam as informações recolhidas durante a sua utilização deste site (denominado como “sua informação”).
	<br><br>
	As suas informações são recolhidas de duas maneiras. Quando navega na “%1$s”, o software phpBB cria vários cookies. Os cookies são pequenos ficheiros de texto armazenados nos ficheiros temporários do seu browser. Os dois primeiros cookies contêm um identificador de utilizador (denominado como “user-id”) e um identificador de sessão anónimo (denominado como “session-id”), ambos atribuídos automaticamente pelo software phpBB. Um terceiro cookie será criado assim que navegar pelos tópicos da “%1$s”. Armazena informações sobre quais os tópicos que leu, melhorando assim a sua experiência de utilizador.
	<br><br>
	Também podemos criar cookies externos ao software phpBB enquanto navega em “%1$s”. Estes estão fora do âmbito deste documento, que apenas abrange os cookies criados pelo software phpBB.
	<br><br>
	A segunda forma de recolhermos informação é através do que nos envia. Isto inclui, entre outros: publicações como utilizador anónimo (denominado como “publicações anónimas”), registo no “%1$s” (denominado como “a sua conta”), publicações que envia após o registo e enquanto estiver ligado (denominado como “as suas publicações”).
	<br><br>
	A sua conta conterá, no mínimo: um nome de utilizador único (denominado como “o seu nome de utilizador”), uma palavra-passe pessoal usada para login (“sua palavra-passe”) e um endereço de e-mail válido (“seu e-mail”). As informações da sua conta no “%1$s” estão protegidas pelas leis de proteção de dados aplicáveiso país onde o nosso servidor está localizado. Quaisquer informações para além do seu nome de utilizador, palavra-passe e endereço de e-mail solicitadas durante o registo poderão ser obrigatórias ou opcionais, de acordo com o critério do “%1$s”. Em todos os casos, pode escolher quais as informações da sua conta que serão exibidas publicamente. Pode também optar por receber ou não receber e-mails automáticos gerados pelo software phpBB.
	<br><br>
	Sua senha é codificada em nosso banco de dados para uma maior segurança. No entanto, recomendamos que não reutilize a mesma palavra-passe em vários sites. A sua palavra-passe é a chave para a sua conta no “%1$s”, por isso mantenha-a em segurança. Em nenhuma circunstância alguém afiliado ao “%1$s”, phpBB ou terceiros solicitará a sua palavra-passe de forma legítima. Se se esquecer da sua palavra-passe, pode utilizar o recurso “Esqueci-me da palavra-passe” fornecido pelo software phpBB. Este processo exige que envie o seu nome de utilizador e endereço de e-mail, após o que o software phpBB irá gerar uma nova palavra-passe para que possa recuperar o acesso à sua conta.
	',
));
